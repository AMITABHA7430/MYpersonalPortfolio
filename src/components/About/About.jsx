    ...
    />
          ...
          <div className="md:7/12 lg:w-6/12">
            ...
            <p className="mt-4 text-gray-600">
              My skills include HTML, CSS, JavaScript, React, Java, Python, C Programming, Git & GitHub, 
              and basic SQL/MySQL. I’ve built projects like a <a href="https://amitabha7430.github.io/weather-report-web" target="_blank" className="text-blue-600 underline">Weather App</a> using 
